...
import com.arka.gestorsolicitudes.domain.port.in.GestorSolicitudesUseCase;
import com.arka.gestorsolicitudes.infrastructure.adapter.in.web.dto.RespuestaProveedorDto;
import com.arka.gestorsolicitudes.infrastructure.adapter.in.web.dto.SolicitudProveedorRequestDto;
import com.arka.gestorsolicitudes.infrastructure.adapter.in.web.dto.SolicitudProveedorResponseDto;
import com.arka.gestorsolicitudes.infrastructure.adapter.in.web.mapper.GestorSolicitudesWebMapper;
...
public class GestorSolicitudesController {
    ...
    public ResponseEntity<SolicitudProveedorResponseDto> consultarSolicitud(@PathVariable("solicitudId") String solicitudId) {
        try {
    ...
    public ResponseEntity<List<SolicitudProveedorResponseDto>> obtenerSolicitudesPorEstado(@PathVariable(name = "estado") String estado) {
        try {
    ...
    public ResponseEntity<SolicitudProveedorResponseDto> actualizarEstado(
            @PathVariable(name = "solicitudId") String solicitudId,
