...
import com.soporte.app.aplication.useCase.RequestApplicationService;
import com.soporte.app.aplication.useCase.SupportProductUseCase;
import com.soporte.app.infrastructure.adapter.in.web.dto.request.SolicitudRequest;
...
public class RequestManagerController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RequestManagerController.class);
    
    private final RequestApplicationService solicitudService;
    private final SupportProductUseCase productUseCase;
    
    public RequestManagerController(RequestApplicationService solicitudService, SupportProductUseCase productUseCase) {
    ...
    public CompletableFuture<ResponseEntity<SolicitudResponseDto>> crearSolicitudCotizacion(
        ...
        try {
            List<ResponseSupportProduct> productos = request.getProductIds().stream()
