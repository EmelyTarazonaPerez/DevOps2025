package com.soporte.app.infrastructure.adapter.out.microservice;
...
@Component
public class RequestManagerServiceAdapter implements RequestManagerServicePort {
    
    private static final Logger logger = LoggerFactory.getLogger(RequestManagerServiceAdapter.class);
    
    private final RestTemplate restTemplate;
    private final String gestorSolicitudesBaseUrl;
    
    public RequestManagerServiceAdapter(RestTemplate restTemplate,
